...
CALLBACK_SEARCH_QUERY LoadImageCallbackQueries[] = {
	...
	{ WINDOWS_INDEX::WX_19045, RTL_CONSTANT_STRING(L"PsSetLoadImageNotifyRoutineEx"),       RTL_CONSTANT_STRING(L"PsSetCreateProcessNotifyRoutine"),           LI_PATTERN_WX_10240, sizeof(LI_PATTERN_WX_10240), -4 },
};
...
CALLBACK_SEARCH_QUERY CreateProcessCallbackQueries[] = {
	...
	{ WINDOWS_INDEX::WX_19045, RTL_CONSTANT_STRING(L"PsSetCreateProcessNotifyRoutine"),     RTL_CONSTANT_STRING(L"IoCreateDriver"),                            CP_PATTERN_WX_16299, sizeof(CP_PATTERN_WX_16299), -4 },
};

UCHAR CT_PATTERN_W7_07600[] = { 0xbf, 0x40, 0x00, 0x00, 0x00, 0x48, 0x8b, 0xcb, 0xe8 };
UCHAR CT_PATTERN_WX_10240[] = { 0x48, 0x8b, 0xcd, 0xe8 };
CALLBACK_SEARCH_QUERY CreateThreadCallbackQueries[] = {
	...
	{ WINDOWS_INDEX::WX_19045, RTL_CONSTANT_STRING(L"PsRemoveCreateThreadNotifyRoutine"),   RTL_CONSTANT_STRING(L"PsRemoveLoadImageNotifyRoutine"),            CT_PATTERN_WX_10240, sizeof(CT_PATTERN_WX_10240), -8 },
};
...
CALLBACK_SEARCH_QUERY RegistryCallbackQueries[] = {
	...
	{ WINDOWS_INDEX::WX_19045, RTL_CONSTANT_STRING(L"CmUnRegisterCallback"),                RTL_CONSTANT_STRING(L"DbgkLkmdUnregisterCallback"),                RG_PATTERN_WX_10240, sizeof(RG_PATTERN_WX_10240), -9 },
};
...
CALLBACK_SEARCH_QUERY ObjectCallbackQueries[] = {
	...
	{ WINDOWS_INDEX::WX_19045, RTL_CONSTANT_STRING(L"ObCreateObjectType"),                  RTL_CONSTANT_STRING(L"IoCreateDriver"),                            OB_PATTERN_WX_10240, sizeof(OB_PATTERN_WX_10240), 25 },
};
...
WINDOWS_INDEX GetWindowsIndex()
{
	...
	DbgPrint("> TelemetrySourcererDriver: windows version: %ld\n", OsVersionInfo.dwBuildNumber);
...
NTSTATUS GetMinifilterCallbacks(OUT CALLBACK_INFO* CallbackArray, OUT ULONG* CallbackCount)
{
	...
	*CallbackCount = 0;
	...
	for (ULONG i = 0; i < NumberFiltersReturned; i++)
	{
		...
		PFILTER_FULL_INFORMATION FullFilterInfo = (PFILTER_FULL_INFORMATION)ExAllocatePool2(POOL_FLAG_PAGED, BytesReturned, DRIVER_TAG);
		if (!FullFilterInfo)
			continue;
		...
		PFLT_INSTANCE* InstanceList = (PFLT_INSTANCE*)ExAllocatePool2(POOL_FLAG_PAGED, BufferSize, DRIVER_TAG);
		if (!InstanceList)
			continue;
